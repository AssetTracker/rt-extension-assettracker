...
=head1 NAME
  ...
  RTx::AssetTracker::ScripCondition - RT scrip conditional
...
package RTx::AssetTracker::ScripCondition;
...
takes a hash which has the following elements:  TransactionObj and AssetObj.
