...
sub _CoreAccessible {
    {
        ...
        eval "require RTx::AssetTracker::ScripCondition_Overlay";
        if ($@ && $@ !~ qr{^Can't locate RTx/AssetTracker/ScripCondition_Overlay.pm}) {
            die $@;
        };

        eval "require RTx::AssetTracker::ScripCondition_Vendor";
        if ($@ && $@ !~ qr{^Can't locate RTx/AssetTracker/ScripCondition_Vendor.pm}) {
            die $@;
        };

        eval "require RTx::AssetTracker::ScripCondition_Local";
        if ($@ && $@ !~ qr{^Can't locate RTx/AssetTracker/ScripCondition_Local.pm}) {
            die $@;
        };
...
RTx::AssetTracker::ScripCondition_Overlay, RTx::AssetTracker::ScripCondition_Vendor, RTx::AssetTracker::ScripCondition_Local
