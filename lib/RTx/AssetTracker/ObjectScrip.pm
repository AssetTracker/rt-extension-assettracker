...
package RTx::AssetTracker::ObjectScrip;
use base 'RT::Record::AddAndSort';

use RTx::AssetTracker::Scrip;
use RTx::AssetTracker::ObjectScrips;

sub Table {'AT_ObjectScrips'}
sub ObjectCollectionClass {'RTx::AssetTracker::Types'}
...
sub ScripObj {
    ...
    my $obj = RTx::AssetTracker::Scrip->new( $self->CurrentUser );
    $obj->Load( $id );
    return $obj;
}
