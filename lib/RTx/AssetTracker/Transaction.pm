...
sub _CoreAccessible {
    {
        ...
        eval "require RTx::AssetTracker::Transaction_Overlay";
        if ($@ && $@ !~ qr{^Can't locate RTx/AssetTracker/Transaction_Overlay.pm}) {
            die $@;
        };

        eval "require RTx::AssetTracker::Transaction_Vendor";
        if ($@ && $@ !~ qr{^Can't locate RTx/AssetTracker/Transaction_Vendor.pm}) {
            die $@;
        };

        eval "require RTx::AssetTracker::Transaction_Local";
        if ($@ && $@ !~ qr{^Can't locate RTx/AssetTracker/Transaction_Local.pm}) {
            die $@;
        };
...
RTx::AssetTracker::Transaction_Overlay, RTx::AssetTracker::Transaction_Vendor, RTx::AssetTracker::Transaction_Local
