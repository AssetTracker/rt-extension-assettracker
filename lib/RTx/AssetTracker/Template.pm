...
sub _CoreAccessible {
    {
        ...
        eval "require RTx::AssetTracker::Template_Overlay";
        if ($@ && $@ !~ qr{^Can't locate RTx/AssetTracker/Template_Overlay.pm}) {
            die $@;
        };

        eval "require RTx::AssetTracker::Template_Vendor";
        if ($@ && $@ !~ qr{^Can't locate RTx/AssetTracker/Template_Vendor.pm}) {
            die $@;
        };

        eval "require RTx::AssetTracker::Template_Local";
        if ($@ && $@ !~ qr{^Can't locate RTx/AssetTracker/Template_Local.pm}) {
            die $@;
        };
...
RTx::AssetTracker::Template_Overlay, RTx::AssetTracker::Template_Vendor, RTx::AssetTracker::Template_Local
